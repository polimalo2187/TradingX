...
def run_trading_for_user(user_id):
    ...
    try:
        ...
        # Liberar bandera para permitir un nuevo ciclo
        active_threads.pop(user_id, None)
...
def scheduler_loop(interval_seconds=60):
    """
    Revisa cada X segundos los usuarios activos y
    ejecuta un ciclo de trading por usuario, evitando
    hilos duplicados.
    """
...
def start_scheduler():
    ...
    Este hilo funciona paralelo al bot de Telegram.
    """

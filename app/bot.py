...
# =======================================
# ACTIVAR TRADING (CON HILO DE BACKGROUND)
# =======================================
...
async def activate_trading_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Lanzar el motor de trading sin bloquear el bot
    threading.Thread(target=trading_cycle, args=(user_id,), daemon=True).start()

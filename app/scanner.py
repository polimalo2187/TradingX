...
def fetch_pairs():
    ...
    - Pares con velas activas y válidas
    """
    ...
    # En CoinEx los pares vienen como: BTCUSDT, ETHUSDT, XRPUSDT...
    ...
    for symbol in usdt_pairs:
        try:
            ...
            # CoinEx devuelve velas en formato:
            # [timestamp, open, close, high, low, volume]
            # Verificamos que existan velas reales
...
def evaluate_pairs(pairs):
    """
    Analiza cada par y detecta oportunidades Breakout reales.
    """
...
def select_best_pairs(opportunities):
    ...
    # Tomar top N según configuración
